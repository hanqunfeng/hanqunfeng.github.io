...
!function () {
    ...
    var _ = Array.prototype.indexOf, C = Object.assign, E = /MicroMessenger/i.test(navigator.userAgent),
        ...
        D = c("description") || c("Description") || "", b = {
            ...
            sites: ["qq","tencent","qzone","wechat","facebook","twitter", "google"],
            mobileSites: [],
            disabled: [],
            initialized: !1
        }, B = {
            ...
            qq: "http://connect.qq.com/widget/shareqq/index.html?url="+url+"&title="+title+"&source="+origin+"&desc=&pics=",
            tencent: "http://share.v.t.qq.com/index.php?c=share&a=index&title="+title+"&url="+url+"&pic=",
            weibo: "http://service.weibo.com/share/share.php?url=&title=&pic=&appkey=",
            wechat: "javascript:",
